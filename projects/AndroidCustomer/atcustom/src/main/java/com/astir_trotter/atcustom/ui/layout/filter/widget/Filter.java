...
import com.astir_trotter.atcustom.ui.layout.filter.adapter.FilterAdapter;
...
import com.astir_trotter.atcustom.ui.layout.filter.listener.FilterListener;
import com.astir_trotter.atcustom.ui.layout.filter.model.Coord;
...
public class Filter<T> extends FrameLayout implements FilterItemListener, CollapseListener {

    private static final String STATE_SUPER = "state_super";
    private static final String STATE_SELECTED = "state_selected";
    private static final String STATE_REMOVED = "state_removed";
    private static final String STATE_COLLAPSED = "state_collapsed";

    FilterAdapter<T> adapter = null;
    FilterListener<T> listener = null;
    int margin = dpToPx(getDimen(R.dimen.margin));
    String noSelectedItemText = "";
        set(value) {
        collapsedText.text = value
        }

    String textToReplaceArrow = "";
        set(value) {
        collapseView.setText(value)
        }

    boolean replaceArrowByText = false;
        set(value) {
        collapseView.setHasText(value)
        }

    int collapsedBackground = Color.WHITE;
        set(value) {
        field = value
    ...
    int expandedBackground = Color.WHITE;
        set(value) {
        field = value
    ...
    private LinkedHashMap<FilterItem, Coord> mSelectedFilters = new LinkedHashMap<>();
