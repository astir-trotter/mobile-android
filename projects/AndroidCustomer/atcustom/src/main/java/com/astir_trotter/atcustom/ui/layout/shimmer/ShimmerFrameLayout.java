...
public class ShimmerFrameLayout extends FrameLayout {
    ...
    private static final String TAG = ShimmerFrameLayout.class.getSimpleName();
    ...
    private Bitmap tryCreateRenderBitmap() {
        ...
        try {
            return ImageUtils.createBitmapAndGcIfNecessary(width, height);
    ...
    private Bitmap getMaskBitmap() {
        ...
        mMaskBitmap = ImageUtils.createBitmapAndGcIfNecessary(width, height);
